...
package my.borer.output

import my.borer.{Borer, ByteAccess, Output}
import my.borer.Output.ToTypeProvider
import my.borer.internal.ByteArrayCache

import scala.annotation.tailrec

trait ToByteArrayOutput:

  given ToByteArrayProvider: ToTypeProvider[Array[Byte]] with
