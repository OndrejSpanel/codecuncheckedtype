...
import my.borer.*
import my.borer.internal.{CharArrayCache, Parser, Util}
 ...
 */
final private[borer] class DirectJsonParser(val input: my.borer.Input.FromByteArray, val config: JsonParser.Config)
    extends Parser[Array[Byte]]:
  ...
  def padBytes(rest: Array[Byte], missing: Long) = throw new UnsupportedOperationException
