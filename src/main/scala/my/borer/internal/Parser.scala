...
import my.borer.{ByteAccess, DataItem, Input, Receiver}

/**
 * Common parent type of [[my.borer.cbor.CborParser]] and [[my.borer.json.JsonParser]]
 */
abstract private[borer] class Parser[Bytes] extends Input.PaddingProvider[Bytes]:
   ...
   * The returned `Int` is the [[my.borer.DataItem]] code for the value the [[Receiver]] received.
   */
